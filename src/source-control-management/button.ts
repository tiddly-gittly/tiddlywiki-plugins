...
if ($tw.browser) {
  class NodeJSGitSyncWidget extends Widget {
    ...
    render(parent: Element, nextSibling: Element | null) {
      ...
      syncStateButton.className = 'tc-btn-invisible tc-btn-plugins-linonetwo-tidgi-desktop-git-sync-button ';
  ...
  exports['tidgi-desktop-git-sync-button'] = NodeJSGitSyncWidget;
}
